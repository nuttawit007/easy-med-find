      ...
      <div className="w-full max-w-md rounded-3xl border border-border bg-card p-8 shadow-glow">
        ...
        <Tabs defaultValue="login">
          ...
          <div className="space-y-3">
            <Button variant="outline" className="w-full" onClick={() => toast("Google login (mock)")}>
            ...
            <Button variant="outline" className="w-full bg-[#06C755] text-white hover:bg-[#06C755]/90 hover:text-white" onClick={() => toast("LINE login (mock)")}>
              Continue with LINE
            </Button>
          </div>
