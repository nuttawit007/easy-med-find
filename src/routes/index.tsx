    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild size="lg" className="shadow-glow">
                <a href="#search">
                  {t("home.startExploring")} <ArrowRight className="ml-1 h-4 w-4" />
                </a>
              </Button>
      ...
      <section className="container mx-auto px-4 pb-6">
        <div className="mb-4 flex items-end justify-between">
          <div>
            <h2 className="text-2xl font-bold">{t("home.hotPromotions")}</h2>
            <p className="text-sm text-muted-foreground">{t("home.hotPromotionsSub")}</p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="mb-4 flex items-end justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{t("home.recommendedSub")}</p>
          </div>
        </div>
